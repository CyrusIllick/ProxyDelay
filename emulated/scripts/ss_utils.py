...
def parse_ss_log_timed(path: Path, target_ports: Optional[Sequence[int]] = None) -> List[TimedFlowSample]:
    target_set = set(target_ports) if target_ports else None
    samples: List[TimedFlowSample] = []
