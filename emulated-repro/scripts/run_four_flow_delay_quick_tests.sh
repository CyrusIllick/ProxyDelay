...
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/results/quickstart/four_flow_delay}"
...
run_case() {
  ...
  for ((rep = 1; rep <= REPS; rep++)); do
    ...
    mkdir -p "${outdir}"
    echo "[quick-four-flow] family=${family_name} rep=${rep} delays=${delay_a},${delay_b},${delay_c},${delay_d}"
...
run_case "bbrhyblacubicreno_10_20_30" "bbr:1,hybla:1,cubic:1,reno:1" 10 20 30 10
run_case "bbrhyblacubicreno_60_70_80" "bbr:1,hybla:1,cubic:1,reno:1" 60 70 80 60
run_case "illinoiswestwoodcubicreno_5_15_30" "illinois:1,westwood:1,cubic:1,reno:1" 5 15 30 5
run_case "illinoiswestwoodcubicreno_35_40_45" "illinois:1,westwood:1,cubic:1,reno:1" 35 40 45 35
